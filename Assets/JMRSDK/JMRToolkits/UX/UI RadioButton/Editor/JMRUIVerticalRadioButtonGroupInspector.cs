...
namespace JMRSDK.Toolkit.UI.Inspector
{
    ...
    public class JMRUIVerticalRadioButtonGroupInspector : Editor
    {
        #region Editor Actions
        const string PrefabGUID = "c425b55bc7ceee14ca99c44b546cceee";

        private static string PrefabPath => AssetDatabase.GUIDToAssetPath(PrefabGUID);

        [MenuItem("JioMixedReality/Toolkits/V2/Vertical Radiobutton Group")]
