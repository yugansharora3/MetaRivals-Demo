...
{
    [CustomEditor(typeof(JMRUIPrimaryRadioButton))]
    public class JMRUIPrimaryRadioButtonInspector : Editor
    {
        #region Editor Actions
        const string PrefabGUID = "2898394119e46244bba948d38e62351b";

        private static string PrefabPath => AssetDatabase.GUIDToAssetPath(PrefabGUID);

        [MenuItem("JioMixedReality/Toolkits/V2/Radiobutton")]
