...
{
    [CustomEditor(typeof(JMRUIPrimaryToggleButton))]
    public class JMRUIPrimaryToggleButtonInspector : Editor
    {
        #region Editor Actions

        const string PrefabGUID = "b64a2831748c20c45983429f77bc0af5";

        private static string PrefabPath => AssetDatabase.GUIDToAssetPath(PrefabGUID);


        [MenuItem("JioMixedReality/Toolkits/V2/Toggle")]
