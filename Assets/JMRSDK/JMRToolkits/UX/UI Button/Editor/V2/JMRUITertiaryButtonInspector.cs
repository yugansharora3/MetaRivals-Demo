...
namespace JMRSDK.Toolkit.UI.Inspector
{
    ...
    public class JMRUITertiaryButtonInspector : Editor
    {
        #region Editor Actions

        const string PrefabGUID = "b0c1400afbaca7a4690be0be69e35bbd";//"907db0e31f92d6843ac597e0d0de6fcc";//"7ecd6301ec5f89a468e705b721a1cf37";

        private static string PrefabPath => AssetDatabase.GUIDToAssetPath(PrefabGUID);

        [MenuItem("JioMixedReality/Toolkits/V2/Tertiary Button", false)]
